    ...
    "break-words" // Use Tailwind's break-words class for word wrap
        ...
        >
          ...
          {message?.attachments?.length > 0 ? (
            <div
              className={classNames(
                "grid max-w-7xl gap-2 text-dark",
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="absolute inset-0 z-20 flex justify-center items-center w-full gap-2 h-full  group-hover:opacity-100 opacity-0 transition-opacity ease-in-out duration-150"
                    >
                      ...
                      >
                        <ArrowDownTrayIcon
                          title="download"
                          className="hover:text-zinc-400 h-6 w-6  cursor-pointer"
                        />
                      </a>
                    </button>
                    <img
          ...
          {message.content ? (
            <p className={isOwnMessage ? "text-[#212A3E]" : "text-[#212A3E]"}>
              {message.content}
            </p>
          ) : null}
          <p
