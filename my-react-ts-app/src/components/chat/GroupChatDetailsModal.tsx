                      ...
                      <div className="flex flex-col justify-center items-start">
                        <div className="flex pl-16 justify-center items-center relative w-full h-max gap-3 ">
                          {groupDetails?.participants.slice(0, 3).map((p) => {
                            return (
                              <img
                                className="w-24 h-24 -ml-16 rounded-full outline outline-0 outline-secondary "
                                key={p._id}
                                src={p.avatar.url}
                                alt="avatar"
                              />
                        ...
                        <div className="w-full flex flex-col justify-center items-center text-center text-dark  ">
                          {renamingGroup ? (
                            <div className="w-full flex justify-center items-center mt-5 gap-2">
                              ...
                              />
                              <Button
                                className="bg-gradient-to-tr from-indigo-200 to-indigo-100 text-[#212A3E]"
                                severity="primary"
                          ...
                          <p className="mt-2 text-dark-400 text-dark">
                                ...
                                <React.Fragment key={part._id}>
                                  <div className="flex justify-between items-center w-full py-4">
                                    <div className="flex justify-start items-start gap-3 w-full">
                                      ...
                                      />
                                      <div>
                                        <p className="text-dark font-semibold text-dark inline-flex items-center w-full">
                                          {part.username}{" "}
