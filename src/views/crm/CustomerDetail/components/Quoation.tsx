    ...
    useEffect(() => {
      ...
      if (projectId) {
        const fetchData = async () => {
          try {
            const response = await fetch(`https://col-back1.test.psi.initz.run/v1/api/admin/getsingle/quotation/?project_id=${projectId}&quotation_id=${quotation_id}&type=${quotation_type}`);
